...
<div class="p-6 bg-white rounded-lg shadow-md">
    <h2 class="text-xl font-semibold mb-6">{{ __('Créer un Utilisateur') }}</h2>
    ...
    <form wire:submit.prevent="create">
        ...
        <div class="mb-4">
            <label for="password_confirmation" class="block text-sm font-medium text-gray-700">{{ __('Confirmation du mot de passe') }}</label>
