<!-- resources/views/livewire/product-families/edit-product-family.blade.php -->
<div>
    <form wire:submit.prevent="update">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
                <h2 class="text-lg font-semibold mb-6">{{ __('Modifier la famille de produits') }}</h2>
                
                <!-- Code (Disabled) -->
                <div class="mb-4">
                    <label for="familyCode" class="block text-sm font-medium text-gray-700">{{ __('Code') }}</label>
                    <input type="text" id="familyCode" value="{{ $family->code }}" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm" disabled>
